...
const Admin = (props) => {
    ...
    const newProduct = (name, size, product_price, url, color, gender) => async (dispatch) => {
        try {
            ...
            const product = await axios.post('https://sergi.lighthousemarketing.es/public/api/create'/* 'http://localhost:8000/api/create' */, body, config)
    ...
    const updateProducts = (name, size, product_price, url, color, gender) => async (dispatch) => {
        try {
            ...
            const product = await axios.put(`https://sergi.lighthousemarketing.es/public/api/updatedproduct/${newId}`/* `http://localhost:8000/api/updatedproduct/${newId}` */, body, config);
    ...
    const deleteProducts = () => async (dispatch) => {
        try {
            ...
            const product = await axios.delete(`https://sergi.lighthousemarketing.es/public/api/deleteproduct/${newId}`/* `http://localhost:8000/api/deleteproduct/${newId}` */, config);
